...
import { MenuAlt2Icon, MenuIcon, XIcon } from "@heroicons/react/outline";
  ...
  return (
    <>
        ...
        <Transition.Root show={sidebarOpen} as={Fragment}>
          ...
          >
            <Transition.Child
              ...
              leaveTo="opacity-0"
            >
              <Dialog.Overlay className="fixed inset-0 bg-neutral-800 bg-opacity-75" />
            </Transition.Child>
            <Transition.Child
              as={Fragment}
            ...
            >
              <div className="relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-dark border-2 border-b-neutral-900 border-x-transparent border-t-transparent">
                <Transition.Child
                  as={Fragment}
                ...
                <div className="flex-shrink-0 flex items-center px-4 text-2xl font-semibold cursor-pointer text-indigo-400">
                  <Link href="/">{process.env.NEXT_PUBLIC_PROJECT_NAME}</Link>
                </div>
                <div className="px-4 py-4">
                  <hr className="w-full border border-neutral-600" />
                </div>
                <div className="flex-1 h-0 overflow-y-auto scrollbar-thin scrollbar-thumb-neutral-900 scrollbar-track-neutral-800">
                  <nav className="px-4 space-y-1">{getNavigation(true)}</nav>
                </div>
                <div className="px-4">
                  <a
                    href="https://markbase.xyz"
                    className="px-3 py-2 rounded-md text-xs font-medium bg-gray-100 text-gray-800 w-fit flex items-center cursor-pointer"
                  >
      ...
      <div className="hidden sm:block sm:fixed sm:bottom-5 sm:right-5">
        <a
          href="https://markbase.xyz"
          className="px-3 py-2 rounded-md text-xs font-medium bg-gray-100 text-gray-800 w-fit flex items-center opacity-80 hover:opacity-100 cursor-pointer"
        >
          <img className="h-5 w-5" src={MarkbaseFavicon.src} />
          <span className="ml-1">Made with Markbase</span>
        </a>
